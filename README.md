# Proyecto Final React (Desarrollo de Aplicaciones)
...
Se cargaran 3 proyectos este es el #3 y estos son los pasos de la instalacion:

- Este es el proyecto #3 de React y ya esta pre-armado hay que instalarlo de manera local en nuestro equipo, ya terminando los requerimientos hay que subir el proyecto a un repositorio creado por el alumno a una rama, la nomenclatura de la rama sera ### add-examen2-nombre-alumno.
...
- Del repositorio seleccionado da_evaluacion_page3 descargar el archivo .zip cargado.
